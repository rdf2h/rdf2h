...
RDF2h.prototype.getRenderer = function (renderee) {
    ...
    return function (renderee) {
        try {
            return (new Function("n", "context", "$rdf", "render", js.value))(renderee.graphNode, renderee.context, rdf, (n, context) => rdf2h.render(n.graph. n.node, context ? context : renderee.context));
        } catch(err) {
